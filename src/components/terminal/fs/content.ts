 ...
 */
export const ROOT_LABEL = 'outlierli.devserver'

export const SOCIAL_LINKS: { label: string; href: string }[] = [
  { label: 'github', href: 'https://github.com/OutlierLi' }
]

export const README_TEXT = `outlierli.devserver — a pseudo-FS over my published content.

If you're an AI agent the easy path is the public manifest:
  GET https://outlierli-s-blog.pages.dev/api/knowledge/index.json
...
If you're poking around in dev mode:
  ...
  manifest         — same data as the site manifest, in this terminal
`
...
export const MOTD_TEXT = `Welcome to outlierli.sh dev mode.
